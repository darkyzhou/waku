    ...
    return new Promise((resolve, reject)=>{
        ...
        server.on('error', (err)=>{
            if (err.code === 'EADDRINUSE') {
                ...
                startServer(app, port + 1).then(resolve).catch(reject);
            } else {
