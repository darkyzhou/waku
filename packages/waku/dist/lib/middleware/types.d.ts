...
import type { EntriesDev, EntriesPrd, HandlerReq, HandlerRes } from '../types.js';
...
export type ErrorCallback = (err: unknown, ctx: HandlerContext, origin: 'handler' | 'rsc' | 'html') => void;
