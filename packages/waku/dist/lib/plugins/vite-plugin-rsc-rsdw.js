...
const patchRsdw = (code, type)=>{
    ...
    return code.replaceAll('function requireAsyncModule(id)', `
    ...
    return {
        ...
        async resolveId (id, importer, options) {
            ...
            if (id.endsWith('/react-server-dom-webpack/client.edge.js')) {
                id = id.slice(0, -'/client.edge.js'.length) + `/cjs/react-server-dom-webpack-client.edge.${mode === 'production' ? 'production' : 'development'}.js`;
...
//# sourceMappingURL=vite-plugin-rsc-rsdw.js.map