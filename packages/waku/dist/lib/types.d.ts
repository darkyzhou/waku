...
type RenderRsc<Opts = unknown> = (elements: Record<string, unknown>, options?: Opts) => Promise<ReadableStream>;
type RenderHtml<Opts = unknown> = (elements: Elements, html: ReactNode, options: {
    rscPath: string;
...
export type HandleRequest = (input: ({
    type: 'component';
    rscPath: string;
    rscParams: unknown;
} | {
...
export type HandleBuild = (utils: {
    ...
    unstable_generatePrefetchCode: (rscPaths: Iterable<string>, moduleIds: Iterable<string>) => string;
